"""Italic annotation processor (replace): wrap span_content in markdown *."""
...
def italic_processor(
    annotation: Annotation,
    span_content: str,
) -> ProcessorResult:
    """Wrap span content in * for markdown italic. No metadata."""
    if annotation.value == "True" and span_content:
        replacement = f"{ITALIC_WRAPPER}{span_content}{ITALIC_WRAPPER}"
    else:
